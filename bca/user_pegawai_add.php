...
if($_GET) {
	if(isset($_POST['btnSave'])){
		...
		if (count($pesanError)>=1 ){
			...
			$mySql  	= "INSERT INTO user (kd_user, nm_user, no_telepon, 
											 username, password, level, id_master)
							VALUES ('$kodeBaru', 
									'$txtNamaUser', 
									'$txtTelpon', 
									'$txtUsername', 
			...
			if($myQry){
				echo "<meta http-equiv='refresh' content='0; url=?page=UserPegawai-Data'>";
			}
			exit;
		}	
	} // Penutup POST
	...
	$dataIdMaster	= isset($_POST['txtIdMaster']) ? $_POST['txtIdMaster'] : '';
} // Penutup GET
?>

<p>&nbsp;</p>
<form action="?page=UserPegawai-Add" method="post" name="form1" target="_self">
  <table width="700" class="table-list" border="0" cellspacing="1" cellpadding="4">
   <tr>
    ...
    <tr>
    <tr>
       <th colspan="3" align="left"><b>ADD USER </b></th>
    </tr>
    <tr>
