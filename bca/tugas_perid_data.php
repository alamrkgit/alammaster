  ...
  <tr>
    <td colspan="2"><table class="table-list" width="100%" border="0" cellspacing="1" cellpadding="2">
      <tr>
        ...
        <td width="38" align="center" bgcolor="#CCCCCC"><b>Aksi</b></td> 
      </tr>
      <?php
	...
	?>
      <tr bgcolor="<?php echo $warna; ?>">
		...
		<td align="center"><a href="?page=LaporanTugasPerId&Kode=<?php echo $Kode; ?>" target="_self" alt="Laporan">View</a></td>
          </tr>
      <?php } ?>
    </table>
    </td>
