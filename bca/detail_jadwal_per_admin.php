...
$pageSql = "SELECT r.*, u.nm_user, p.id AS id_penjadwalan, p.tanggal AS tgl_penjadwalan, p.tgl_mulai AS tgl_mulai, p.tgl_selesai AS tgl_selesai, p.keterangan AS ket_penjadwalan FROM REQUEST as r
			   ...
			   p.id_request = r.id
			   where row_status = '0' AND status='diterima' and r.id_user = '$id_user'";
...
<table width="800" border="0" cellpadding="2" cellspacing="1" class="table-border">
  ...
  <tr>
	...
	?>
	    ...
	    <td align="center"><a href="?page=PegawaiJadwalPerAdmin-Data&Kode=<?php echo $Kode; ?>" target="_self" alt="Edit Data">View</a></td>
